...
//     const token = jwt.sign({ id: user.id, username: user.username }, 'lokananthan', { expiresIn: '7h' });
//     res.json({ token });
//   });
// });
...
const calculateAmount = (weight, region) => {
  // const { amount250, amount1000, additional500 } = rates[region] || rates['Tamil Nadu & Pondicherry'];
  const { amount250 = 0, amount1000 = 0, additional500 = 0 } = rates[region] || { amount250: 0, amount1000: 0, additional500: 0 };
  let totalAmount = 0;
